...
public class PlayerTankMode : MonoBehaviour
{
    ...
    void Start()
    {
        // on r�cup�re une r�f�rence vers le CharacterController du Player
    ...
    void Update()
    {
        ...
        // ici on utilise la fonction SimpleMove du CharacterController avec la composante z de l'input pour le d�placement ( axe Vertical )
